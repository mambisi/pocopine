---
title: "First-party credentials"
description: "First-party email + password auth: implement UserStore/TokenStore and plug in Credentials as a server plugin."
---
...
- `Credentials<S, T>` builder that mounts
  ...
  [`ServerPlugin`](../server/server-plugins.md).
...
- Phone-OTP / username-based / passkey / OAuth flows. Those are
  **different credential types** and ship as **sibling crates**
  ...
  guards work identically. See [`auth-phone-otp-tutorial.md`](../../tutorials/phone-otp-auth.md)
