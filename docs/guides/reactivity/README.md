...
| React to a field changing | `#[watch(field)]` `(&self, new, prev)` | [Essentials](./01-essentials.md) |
...
- [Migrating mutable watchers](./06-readonly-watch-migration.md) — the shared
  receiver contract and moving derivations and state transitions to their owners.
