...
Use `public` only for intentionally open endpoints. Sensitive server
functions should use `#[pocopine::server(guard = ...)]`; see the
[server functions guide](../server/server-functions.md).
