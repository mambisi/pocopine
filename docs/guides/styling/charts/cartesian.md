...
description: "pine-cartesian-chart is the compound-component surface for Cartesian charts. It follows the same pattern as Pine UI primitives: children describe chart…"
---
