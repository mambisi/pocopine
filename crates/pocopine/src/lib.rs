...
pub use pocopine_core::{
    ...
    watch_scope_field_scoped, watch_scoped, App, AppBootCompleted, AppBootFailed, AppBootStarted,
    AppPlugin, Body, Component, ComponentEvent, ComponentMountFn, ComponentMounted,
    ComponentPluginExt, ComponentReady, ComponentSetup, ComponentState, ComponentUnmounted,
    ...
    RegistryErrorKind, RouteNavigationCompleted, RouteNavigationFailed, RouteNavigationStarted,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        PluginValidationError, Plugins, Principal, Role, RouteNavigationCompleted,
        RouteNavigationFailed, RouteNavigationStarted, RwSignal, Scope, ScopeId, ServerError,
