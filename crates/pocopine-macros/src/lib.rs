...
/// `route!{}` - route-crate entry point for the shared route ABI.
///
/// The macro declares stable route identity and emits a serializable
/// descriptor. It intentionally does not export a `ComponentVTable` or
/// Rust function pointers across artifacts.
#[proc_macro]
