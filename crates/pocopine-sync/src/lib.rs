...
pub use protocol::{
    ...
    MigrationOutcome, MutationId, RowKey, RowVersion, StreamParams, SyncChange, SyncCollectionName,
    ...
    SyncStreamSubscription, MAX_SYNC_TOKEN_LEN, SYNC_ENDPOINT_PREFIX, SYNC_OPEN_PATH,
