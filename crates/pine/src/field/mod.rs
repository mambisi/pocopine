...
// `<input>` / `<textarea>` or a Pine form primitive here;
// `accepts` keeps this loose while documenting the canonical
// controls.
#[slot(
    default,
    accepts = [crate::input::PineInput, crate::textarea::PineTextarea]
)]
