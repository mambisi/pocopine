...
|---|---:|---:|---:|---:|---:|
| run(1000) | 165.14 | 192.72 (1.17×) | 193.89 (1.17×) | 216.68 (1.31×) | 222.48 (1.35×) |
| update every 10th | 144.40 | 157.76 (1.09×) | 149.74 (1.04×) | 162.26 (1.12×) | 141.94 (0.98×) |
| select | 110.47 | 125.43 (1.14×) | 114.57 (1.04×) | 128.99 (1.17×) | 994.06 (9.00×) |
| swapRows | 146.46 | 149.85 (1.02×) | 144.92 (0.99×) | 163.06 (1.11×) | 155.49 (1.06×) |
| remove | 161.86 | 170.47 (1.05×) | 168.75 (1.04×) | 187.67 (1.16×) | 166.72 (1.03×) |
| clear | 165.37 | 195.12 (1.18×) | 177.84 (1.08×) | 219.03 (1.32×) | 213.28 (1.29×) |
| runLots(10000) | 586.20 | 687.84 (1.17×) | 720.51 (1.23×) | 852.00 (1.45×) | 899.08 (1.53×) |
| add(1000) | 226.16 | 230.21 (1.02×) | 258.61 (1.14×) | 273.15 (1.21×) | 267.76 (1.18×) |
| **geomean** | **184.95** | **204.09 (1.10×)** | 201.29 (1.09×) | 227.10 (1.23×) | 283.55 (1.53×) |
